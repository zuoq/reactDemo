...
import MiddleFind from '../../components/middlefind'
import RightTest from '../../components/right'
import Footer from '../../components/footer'
import * as actions from '../../actions'


class HomeCompoent extends React.Component {
    //constructor(props) {
    //    super(props);
    //}
    ...
    render () {
        ...
        return (
            <div>
                <LeftBar picText={picText} hasLeftPic={hasLeftPic} />
                <MiddleFind />
...
const Home = connect(mapStateToProps,mapDispatchToProps)(HomeCompoent)
export {Home}
